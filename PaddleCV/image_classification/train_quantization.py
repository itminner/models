...
quantization_model_save_dir = './quantization_model/'
...
def build_program(is_train, main_prog, startup_prog, args):
    ...
    with fluid.program_guard(main_prog, startup_prog):
        ...
        with fluid.unique_name.guard():
            data_loader, loss_out, image, net_out = create_model(model, args, is_train)
...
def train(args):
    ...
    train_out, image, net_out = build_program(
        is_train=True,
    ...
    ############################################################################################################
    test_prog = quant.quanter.quant_aware(test_prog, place, quant_config, scope=None, for_test=True)
    train_prog = quant.quanter.quant_aware(train_prog, place, quant_config, scope=None, for_test=False)

    compiled_train_prog = best_strategy_with_compiled_program(args, train_prog, \
    ...
    ############################################################################################################
    float_program, int8_program = quant.quanter.convert(test_prog, fluid.global_scope(), place, quant_config, save_int8=True)
    ...
    fluid.io.save_inference_model(
        ...
        target_vars=[net_out], executor=exe,
